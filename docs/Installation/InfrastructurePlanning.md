...
??? example "Network Deployment Diagram for FTS via Zero Touch Installer"
    * [Source PlatUML](../diagrams/src/net-deploy-rpi.puml)
    * [Generated SVG](../diagrams/gen/net-deploy-rpi.svg)
