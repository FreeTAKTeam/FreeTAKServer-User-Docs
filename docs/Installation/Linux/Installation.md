...
- Configure Web UI
- **TBD** ~~Install [NodeRed](https://github.com/FreeTAKTeam/FreeTAKServer-User-Docs/blob/main/docs/FreeTAKHub/NodeRedinstallation.md) for FreeTAKHub~~
- **TBD** ~~Install the [Web Map](https://github.com/FreeTAKTeam/FreeTAKServer-User-Docs/blob/main/docs/FreeTAKHub/WebMap/Installation.md)~~
- **TBD** ~~Install the [Video Service](https://github.com/FreeTAKTeam/FreeTAKServer-User-Docs/blob/main/docs/FreeTAKHub/Video/Installation.md)~~
...
A separate guide is maintained for  [manual configuration](https://github.com/FreeTAKTeam/FreeTAKServer-User-Docs/blob/main/docs/Installation/PyPi/Linux/ManualConfiguration.md) of your FTS install.
