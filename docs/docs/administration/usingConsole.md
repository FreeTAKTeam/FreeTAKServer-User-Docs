...
the suggested way to edit Configuration files is by using [WinSCP](../Installation/Tools.md), however if you need to edit files in the console you need to use wim  
